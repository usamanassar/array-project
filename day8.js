...
btn10.onclick = () =>
  showResult(numbers, removeDuplicates(numbers), "Removed duplicates");
...
btn12.onclick = () =>
  showResult(numbers, addAll(numbers), "Added all numbers together");
...
btn13.onclick = () =>
  showResult(
    numbers,
    subtractAll(numbers),
    "Subtracted numbers from left to right"
  );
...
btn14.onclick = () =>
  showResult(
    numbers,
    divideAll(numbers),
    "Divided numbers from left to right (ignores division by 0)"
  );
...
btn15.onclick = () =>
  showResult(
    numbers,
    insertionDeletion(numbers),
    "Inserted 99 at index 2 and deleted element at index 4"
  );
